...
- **Documentation (ENV, CONTRIBUTING, RUNBOOK):** [ENV.md](../../shared/ENV.md) is the env var reference. [CONTRIBUTING.md](../../shared/CONTRIBUTING.md) covers dev setup, command table from run.sh/main/data_manager/pyproject, testing, code style (ruff, black), and PR checklist. [RUNBOOK.md](../../shared/RUNBOOK.md) covers deployment, GET /health, API reference, common issues, rollback, and monitoring.
...
- **DataManagerAgent Phase 2-4 (Distributor, Classifier, Transformer) implemented:**
  ...
  - Fund data distribution: `python -m data_manager distribute-funds --funds-dir datasets`. Schema reference: [fund-data-schema.md](../../data_prep/fund-data-schema.md).
