...
Work breakdown (slices/stages), runnable verification commands, solved repeated errors, and changelog. **Update this document when new changes are introduced** (add changelog entries and adjust work breakdown or errors as needed).
...
Summary of notable changes. Newest first. **Keep this section updated when making user-visible or notable changes** (features, fixes, refactors, config, dependencies).
