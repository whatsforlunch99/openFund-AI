...
| user_profile | Audience | Delivery focus (from vision) |
|--------------|----------|------------------------------|
| `beginner` | Beginner Fund Trader | Conclusion-first, analogies, minimal jargon, emphasize risk warnings |
| `long_term` | Long-Term Equity Holder | Industry trends, portfolio/drawdown focus |
| `analyst` | Financial Data Analyst | Full calculation workflow, raw metrics, model assumptions, confidence intervals |

Allowed values are exhaustive for now; unknown values return HTTP 400 (see clarification E2).
...
- **Decisions and types:** [clarification.md](clarification.md) (performatives, ConversationState, TaskStep, create_or_get, SafetyError, user_profile, MCP names, timeouts, persistence, thresholds).  
- **Function-level spec and examples:** [claude-v2.md](claude-v2.md).
